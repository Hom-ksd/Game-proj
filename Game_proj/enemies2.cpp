...
void Enemies2::initEnemySprite()
{
	this->enemySprite.setTexture(this->enemyTexture);
	this->enemySprite.setPosition(this->spawn_x, this->spawn_y);
	this->enemySprite.setTextureRect(this->enemyRect);
	this->enemySprite.setScale(3.5f, 3.5f);
}

Enemies2::Enemies2(sf::Texture* texture, float pos_x, float pos_y, float HP, float DMG)
{
...
const sf::Vector2f Enemies2::getEnemyPos() const
{
	return this->enemySprite.getPosition();
}

const float Enemies2::getEnemyHealth() const
{
	return this->health;
}

const float Enemies2::getEnemyMaxHealth() const
{
	return this->maxHealth;
}

const bool Enemies2::getEnemyState() const
{
	return this->isDead;
}

const sf::FloatRect Enemies2::getBounds() const
{
	return this->enemySprite.getGlobalBounds();
}

void Enemies2::damageEnemy(float amount)
{
	this->health -= amount;
	if (this->health <= 0) {
		//std::cout << "enemy die!\n";
...
const bool Enemies2::getEnemyAtk() const
{
	return this->atkState;
}


void Enemies2::checkBulletHit(sf::FloatRect bulletBounds, float BposX, float BposY)
{
...
void Enemies2::checkPlayerRange()
{
...
void Enemies2::updateEnemiesAnimation()
{
...
void Enemies2::updateEnemiesPos(sf::Vector2i dir)
{
...
void Enemies2::updateEenmiesAtk()
{
	this->time = this->clock.getElapsedTime();
...
void Enemies2::updateEnemies(sf::Vector2i dir)
{
...
void Enemies2::renderEnemies(sf::RenderWindow& target)
{
